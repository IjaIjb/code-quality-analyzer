        ...
        <>
            ...
            <div className="fixed top-4 right-4 z-50 space-y-2">
                {notifications.map((notification) => (
                    <div
                        key={notification.id}
                        className={`px-4 py-3 rounded-lg shadow-lg border transition-all duration-300 ${notification.type === "success"
            ...
            <div className="mt-6 flex justify-center gap-3 flex-wrap">
                <div className="relative">
                    <button
                        ...
                        className={`px-6 py-3 rounded-lg font-medium transition-all flex items-center gap-2 ${analyzedFiles.length === 0
